...
{
	/*Vector2f pos;
	pos = getspritepasto().getPosition();
	getspritepasto().setPosition(pos.x + 0, pos.y + 0);*/
	float X = 0, Y = 0;
	for (int f = 0; f < filas; f++)
	{
		for (int c = 0; c < columnas; c++)
		{
			if (matriz[f][c] == 0 || matriz[f][c] == 2)
			{
				...
				pos = getspritepasto().getPosition();
				getspritepasto().setPosition(pos.x += 50, pos.y += 0);*/
		...
		/*Y += 50.f;*/
		/*spritepasto->move(0, 50);*/
		/*pos = getspritepasto().getPosition();
		getspritepasto().setPosition(pos.x += 0, pos.y += 50);*/
